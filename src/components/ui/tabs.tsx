...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-start gap-1 rounded-xl bg-muted p-1 text-muted-foreground overflow-x-auto overflow-y-hidden scrollbar-hide w-full touch-pan-x overscroll-x-contain",
      className
    )}
    {...props}
  />
